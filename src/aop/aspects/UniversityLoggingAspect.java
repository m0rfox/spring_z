...
//                "списка студентов методом getStudents");
//    }
//
...
//        System.out.println("afterThrowingStudentsLoggingAdvice: логируем выброс " +
//                "исключения " + exception);
//    }

    @After("execution(* getStudents())")
    public void afterGetStudentLoggingAdvice(){
        System.out.println("afterGetStudentLoggingAdvice: логируем нормальное " +
